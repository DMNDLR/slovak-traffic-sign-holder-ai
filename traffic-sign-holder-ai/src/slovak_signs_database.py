...
class SignCategory(Enum):
    ...
    ADDITIONAL = "dodatkové"        # Additional plates
    SERVICE = "servisné"            # Service signs
...
WARNING_SIGNS = {
    ...
    "A13": TrafficSign(
        code="A13", name_sk="Svetelne riadená križovatka", name_en="Traffic lights",
        category=SignCategory.WARNING, shape="triangle", color_scheme="white_red_border",
        description_sk="Značka upozorňuje na svetelne riadenú križovatka",
        description_en="Sign warns of traffic light controlled intersection",
        text_patterns=[], common_variations=[]
    ),
}
...
# INFORMATIONAL SIGNS (INFORMAČNÉ ZNAČKY) - D series
INFORMATIONAL_SIGNS = {
    "D1": TrafficSign(
    ...
    "D10": TrafficSign(
        code="D10", name_sk="Diaľnica", name_en="Motorway",
        category=SignCategory.INFORMATIONAL, shape="rectangle", color_scheme="blue_white",
        description_sk="Značka vyznačuje diaľnicu",
        description_en="Sign indicates motorway",
        text_patterns=[], common_variations=[]
    ),
}

# SERVICE SIGNS (SERVISNÉ ZNAČKY) 
SERVICE_SIGNS = {
    "E1": TrafficSign(
        ...
        text_patterns=["H", "+"], common_variations=["H", "+", "nemocnica"]
    ),
    "E2": TrafficSign(
        ...
        text_patterns=[], common_variations=["benzín", "nafta", "palivo"]
    ),
    "E3": TrafficSign(
        ...
        text_patterns=[], common_variations=["servis", "oprava"]
    ),
    "E4": TrafficSign(
        ...
        text_patterns=[], common_variations=["telefón"]
    ),
    "E5": TrafficSign(
        ...
        text_patterns=[], common_variations=["hotel", "ubytovanie"]
    ),
    "E6": TrafficSign(
        ...
        text_patterns=[], common_variations=["reštaurácia", "jedlo"]
    ),
    "E7": TrafficSign(
        ...
        text_patterns=["WC"], common_variations=["WC", "toalety"]
    ),
}
